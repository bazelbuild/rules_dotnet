...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.6/Chessie.dll",
    refdll = "lib/netstandard1.6/Chessie.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.1/FSharp.Control.AsyncSeq.dll",
    refdll = "lib/netstandard2.1/FSharp.Control.AsyncSeq.dll",
    deps = [
        "@paket2bazel.fsharp.core//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/FSharp.SystemTextJson.dll",
    refdll = "lib/netstandard2.0/FSharp.SystemTextJson.dll",
    pdb = "lib/netstandard2.0/FSharp.SystemTextJson.pdb",
    deps = [
        "@paket2bazel.fsharp.core//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/FSharpx.Async.dll",
    refdll = "lib/netstandard2.0/FSharpx.Async.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/FSharpx.Collections.dll",
    refdll = "lib/netstandard2.0/FSharpx.Collections.dll",
    pdb = "lib/netstandard2.0/FSharpx.Collections.pdb",
    deps = [
        "@paket2bazel.fsharp.core//:lib",
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/FSharpx.Extras.dll",
    refdll = "lib/netstandard2.0/FSharpx.Extras.dll",
    deps = [
        "@paket2bazel.fsharp.core//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.1/Microsoft.Bcl.AsyncInterfaces.dll",
    refdll = "lib/netstandard2.1/Microsoft.Bcl.AsyncInterfaces.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/Microsoft.Web.XmlTransform.dll",
    refdll = "lib/netstandard2.0/Microsoft.Web.XmlTransform.dll",
    pdb = "lib/netstandard2.0/Microsoft.Web.XmlTransform.pdb",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/Mono.Cecil.dll",
    refdll = "lib/netstandard2.0/Mono.Cecil.dll",
    pdb = "lib/netstandard2.0/Mono.Cecil.Mdb.pdb",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/Newtonsoft.Json.dll",
    refdll = "lib/netstandard2.0/Newtonsoft.Json.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net5.0/NuGet.Commands.dll",
    refdll = "lib/net5.0/NuGet.Commands.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/NuGet.Common.dll",
    refdll = "lib/netstandard2.0/NuGet.Common.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/NuGet.Configuration.dll",
    refdll = "lib/netstandard2.0/NuGet.Configuration.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net5.0/NuGet.Credentials.dll",
    refdll = "lib/net5.0/NuGet.Credentials.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net5.0/NuGet.DependencyResolver.Core.dll",
    refdll = "lib/net5.0/NuGet.DependencyResolver.Core.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/NuGet.Frameworks.dll",
    refdll = "lib/netstandard2.0/NuGet.Frameworks.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/NuGet.LibraryModel.dll",
    refdll = "lib/netstandard2.0/NuGet.LibraryModel.dll",
    deps = [
        "@paket2bazel.nuget.common//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/NuGet.PackageManagement.dll",
    refdll = "lib/netstandard2.0/NuGet.PackageManagement.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net5.0/NuGet.Packaging.dll",
    refdll = "lib/net5.0/NuGet.Packaging.dll",
    deps = [
        "@paket2bazel.nuget.configuration//:lib",
        "@paket2bazel.nuget.versioning//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net5.0/NuGet.ProjectModel.dll",
    refdll = "lib/net5.0/NuGet.ProjectModel.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net5.0/NuGet.Resolver.dll",
    refdll = "lib/net5.0/NuGet.Resolver.dll",
    deps = [
        "@paket2bazel.nuget.protocol//:lib",
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/NuGet.Versioning.dll",
    refdll = "lib/netstandard2.0/NuGet.Versioning.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard2.0/Paket.Core.dll",
    refdll = "lib/netstandard2.0/Paket.Core.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.3/System.Collections.Concurrent.dll",
    refdll = "lib/netstandard1.3/System.Collections.Concurrent.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net6.0/System.ComponentModel.Composition.dll",
    refdll = "lib/net6.0/System.ComponentModel.Composition.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net6.0/System.Diagnostics.DiagnosticSource.dll",
    refdll = "lib/net6.0/System.Diagnostics.DiagnosticSource.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net6.0/System.Formats.Asn1.dll",
    refdll = "lib/net6.0/System.Formats.Asn1.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.3/System.IO.FileSystem.Primitives.dll",
    refdll = "lib/netstandard1.3/System.IO.FileSystem.Primitives.dll",
    deps = [
        "@paket2bazel.system.runtime//:lib",
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.6/System.Linq.dll",
    refdll = "lib/netstandard1.6/System.Linq.dll",
    deps = [
        "@paket2bazel.system.collections//:lib",
        "@paket2bazel.system.diagnostics.debug//:lib",
        "@paket2bazel.system.resources.resourcemanager//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net6.0/System.Net.Http.WinHttpHandler.dll",
    refdll = "lib/net6.0/System.Net.Http.WinHttpHandler.dll",
    deps = [
    ],
    data = [
        "lib/net6.0/System.Net.Http.WinHttpHandler.dll",
        "lib/net6.0/System.Net.Http.WinHttpHandler.xml",
    ],
)
import_multiframework_library(
    name = "lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net6.0/System.Runtime.CompilerServices.Unsafe.dll",
    refdll = "lib/net6.0/System.Runtime.CompilerServices.Unsafe.dll",
    deps = [
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.3/System.Runtime.Numerics.dll",
    refdll = "lib/netstandard1.3/System.Runtime.Numerics.dll",
    deps = [
        "@paket2bazel.system.globalization//:lib",
        "@paket2bazel.system.resources.resourcemanager//:lib",
        "@paket2bazel.system.runtime//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netcoreapp3.0/System.Security.Cryptography.Cng.dll",
    refdll = "lib/netcoreapp3.0/System.Security.Cryptography.Cng.dll",
    deps = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netcoreapp3.0/System.Security.Cryptography.OpenSsl.dll",
    refdll = "lib/netcoreapp3.0/System.Security.Cryptography.OpenSsl.dll",
    deps = [
        "@paket2bazel.system.formats.asn1//:lib",
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/net6.0/System.Security.Cryptography.Pkcs.dll",
    refdll = "lib/net6.0/System.Security.Cryptography.Pkcs.dll",
    deps = [
        "@paket2bazel.system.formats.asn1//:lib",
    ],
    data = [
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.3/System.Security.Cryptography.Primitives.dll",
    refdll = "lib/netstandard1.3/System.Security.Cryptography.Primitives.dll",
    deps = [
        "@paket2bazel.system.diagnostics.debug//:lib",
        "@paket2bazel.system.globalization//:lib",
        "@paket2bazel.system.io//:lib",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netcoreapp3.0/System.Text.Json.dll",
...
import_library(
    name = "net6.0",
    target_framework = "net6.0",
    dll = "lib/netstandard1.3/System.Threading.dll",
    refdll = "lib/netstandard1.3/System.Threading.dll",
    deps = [
        "@paket2bazel.system.runtime//:lib",
        "@paket2bazel.system.threading.tasks//:lib",
    ],
