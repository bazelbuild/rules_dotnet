...
| <a id="csharp_library-unsafe"></a>unsafe |  Allow compiling unsafe code. It true, /unsafe is passed to the compiler.   | Boolean | optional | False |
