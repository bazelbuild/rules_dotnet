...
git_repository(
    name = "rules_dotnet_3rd_part",
    commit = "e7871eaf1d751ba09c566e99bc5ce6baa4406c52",
    init_submodules = True,
    remote = "https://github.com/tomaszstrejczek/rules_dotnet_3rd_party.git",
)

load("@rules_dotnet_3rd_part//:repositories.bzl", "rules_dotnet_3rd_party_dependencies")
load(
    "//dotnet:defs.bzl",
