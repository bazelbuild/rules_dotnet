...
def dotnet_repositories_nunit():
    ...
    nuget_package(
        ...
        version = "16.5.0",
        sha256 = "d82d211c5715d93ad01846d86326e1c7354cba6a847119d077b596c8fe5ec5a5",
        core_deps = {
            "netcoreapp2.1": [
               "@microsoft.testplatform.testhost//:netcoreapp2.1_core",
               "@microsoft.codecoverage//:netcoreapp2.1_core",
            ],
            "netcoreapp3.0": [
               "@microsoft.testplatform.testhost//:netcoreapp3.0_core",
               "@microsoft.codecoverage//:netcoreapp3.0_core",
            ],
            "netcoreapp3.1": [
               "@microsoft.testplatform.testhost//:netcoreapp3.1_core",
               "@microsoft.codecoverage//:netcoreapp3.1_core",
            ],
        },
        net_deps = {
            "net45": [
               "@microsoft.codecoverage//:net45_net",
            ],
            "net451": [
               "@microsoft.codecoverage//:net451_net",
            ],
            "net452": [
               "@microsoft.codecoverage//:net452_net",
            ],
            "net46": [
               "@microsoft.codecoverage//:net46_net",
            ],
            "net461": [
               "@microsoft.codecoverage//:net461_net",
            ],
            "net462": [
               "@microsoft.codecoverage//:net462_net",
            ],
            "net47": [
               "@microsoft.codecoverage//:net47_net",
            ],
            "net471": [
               "@microsoft.codecoverage//:net471_net",
            ],
            "net472": [
               "@microsoft.codecoverage//:net472_net",
            ],
            "net48": [
               "@microsoft.codecoverage//:net48_net",
            ],
        },
        mono_deps = [
            "@microsoft.codecoverage//:mono",
        ],
    )
    nuget_package(
    ...
    nuget_package(
        ...
        package = "microsoft.testplatform.testhost",
        version = "16.5.0",
        sha256 = "bbec206237d9e3d185f87f14e9299c4c9a74eccf6bf6560a1449616a8cd69b21",
        core_lib = {
            "netcoreapp2.1": "lib/netcoreapp2.1/cs/Microsoft.TestPlatform.CommunicationUtilities.resources.dll",
            "netcoreapp3.0": "lib/netcoreapp2.1/cs/Microsoft.TestPlatform.CommunicationUtilities.resources.dll",
            "netcoreapp3.1": "lib/netcoreapp2.1/cs/Microsoft.TestPlatform.CommunicationUtilities.resources.dll",
        },
        core_deps = {
            "netcoreapp2.1": [
               "@microsoft.testplatform.objectmodel//:netcoreapp2.1_core",
               "@newtonsoft.json//:netcoreapp2.1_core",
            ],
            "netcoreapp3.0": [
               "@microsoft.testplatform.objectmodel//:netcoreapp3.0_core",
               "@newtonsoft.json//:netcoreapp3.0_core",
            ],
            "netcoreapp3.1": [
               "@microsoft.testplatform.objectmodel//:netcoreapp3.1_core",
