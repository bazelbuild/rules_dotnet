...
net_library(
    name = "net.nunit.core.interfaces.dll",
    srcs = [":NUnitCore_Interfaces_files"],
    defines = ["CLR_4_0"],
    dotnet_context_data = "@io_bazel_rules_dotnet//:net_context_data_net472",
    visibility = ["//visibility:public"],
    deps = [
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.collections.specialized.dll",
...
net_library(
    name = "net.nunit.core.dll",
    srcs = [":NUnitCore_core_files"],
    defines = ["CLR_4_0"],
    dotnet_context_data = "@io_bazel_rules_dotnet//:net_context_data_net472",
    visibility = ["//visibility:public"],
    deps = [
        ":net.nunit.core.interfaces.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.collections.specialized.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.componentmodel.typeconverter.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.diagnostics.tracesource.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.runtime.extensions.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.runtime.remoting.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.text.regularexpressions.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.xml.readerwriter.dll",
    ],
)
...
net_library(
    ...
    deps = [
        ...
        ":net.nunit.core.interfaces.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.collections.specialized.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.configuration.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.drawing.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.runtime.extensions.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.runtime.remoting.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.xml.dll",
        "@io_bazel_rules_dotnet//dotnet/stdlib.net/net472:system.xml.readerwriter.dll",
